...
import numpy as np
from scipy.optimize import OptimizeResult#, _check_unknown_options
...
def _pivot_col(T, tol=1.0E-12, bland=False):
    ...
    of the variable to enter the basis. Always using bland's rule.
...
def _solve_simplex(T, n, basis, maxiter=1000, phase=2, tol=1.0E-12, nit0=0):
    """
    ...
    while not complete:
        ...
        mycallback(solution[:n], **{"tableau": T,
                                      "phase":phase,
                                      "nit":nit,
                                      "pivot":(pivrow, pivcol),
                                      "basis":basis,
...
def _linprog_simplex(c, A_ub=None, b_ub=None, A_eq=None, b_eq=None,
            bounds=None, maxiter=1000, disp=False, tol=1.0E-12, **unknown_options):
    """
    ...
    nit1, status = _solve_simplex(T, n, basis, phase=1, maxiter=maxiter, tol=tol)
